...
For S3, if you don't specify a <code>prefix</code> it will use the bucket URL by default.  You can override this in <code>config/asset_id.yml</code>:

<pre><code>production:
  access_key_id: 'MY_ACCESS_KEY'
  secret_access_key: 'MY_ACCESS_SECRET'
  bucket: "my_live_bucket"
  prefix: "https://mydomain.cloudfront.net"
</code></pre>
